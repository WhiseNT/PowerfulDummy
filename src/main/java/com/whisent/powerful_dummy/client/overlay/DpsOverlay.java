package com.whisent.powerful_dummy.client.overlay;

import com.mojang.blaze3d.platform.Window;
import com.whisent.powerful_dummy.Powerful_dummy;
import com.whisent.powerful_dummy.client.ClientDummyData;
import com.whisent.powerful_dummy.client.DamageHistory;
...
public class DpsOverlay implements LayeredDraw.Layer {
    ...
    public void render(GuiGraphics guiGraphics, DeltaTracker deltaTracker) {
        ...
        renderDamageInfo(guiGraphics, mc, x, y, data, alpha);
    }
    ...
    private static void renderDamageInfo(GuiGraphics gui, Minecraft mc, int x, int y,
        ...
        drawScaledString(gui, mc.font,
                net.minecraft.network.chat.Component.translatable("gui.powerful_dummy.stats.dps")
                        .append(" ")
                        .append(dpsValue).getString(),
                x, y, 0xFFFFFF, 2f);
        gui.drawString(mc.font,
                net.minecraft.network.chat.Component.translatable("gui.powerful_dummy.stats.total_damage")
                        .append(" ")
                        .append(totalDamageValue)
                        .getString(),
                x, y + 24, 0xFFFFFF, true);
        gui.drawString(mc.font, net.minecraft.network.chat.Component.translatable("gui.powerful_dummy.stats.damage_per_hit")
                        .append(" ")
    ...
    private static void drawScaledString(GuiGraphics gui, Font font, String text, int x, int y, int color, float scale) {
        ...
        gui.drawString(font, text,
                (int) (x/scale) , (int) (y/scale), color, true);
        gui.pose().popPose();
    }
