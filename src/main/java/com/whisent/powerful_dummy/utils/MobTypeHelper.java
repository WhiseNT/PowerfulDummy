...
public class MobTypeHelper {
    ...
    static {
        ...
        DISPLAY_NAMES.put(MobType.UNDEFINED, "button.powerful_dummy.undefined");
        DISPLAY_NAMES.put(MobType.UNDEAD, "button.powerful_dummy.undead");
        DISPLAY_NAMES.put(MobType.ARTHROPOD, "button.powerful_dummy.arthropod");
        DISPLAY_NAMES.put(MobType.ILLAGER, "button.powerful_dummy.illager");
        DISPLAY_NAMES.put(MobType.WATER, "button.powerful_dummy.water");
    }
